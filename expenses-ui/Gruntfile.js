  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      livereload: {
        ...
        files: [
          '<%= expenses.app %>/**/*.html',
          '.tmp/styles/{,*/}*.css',
          '<%= expenses.app %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
        ]
      }
    },
    concat: {
    ...
    copy: {
      ...
      webapp : {
        cwd: 'dist',
        src: ['**'],
        dest: '../expenses-core/src/main/webapp/',
        expand: true
      }
    },
    ...
    filerev: {
      dist: {
        src: [
          '<%= expenses.dist %>/scripts/**',
          '<%= expenses.dist %>/styles/{,*/}*.css',
          '<%= expenses.dist %>/styles/fonts/*'
        ]
      }
    },
    htmlmin: {
